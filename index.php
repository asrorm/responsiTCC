  		...
  		<div class="container-fluid">
  			...
  			switch(@$_GET['mod']) {
			      ...
			      <div class="blog-header">
			        <h1 class="blog-title" align="center">SELAMAT DATANG</h1><br/><br/>
			        <p class="lead blog-description"> <a href='http://www.youtube.com/asrorm' target='_blank'>Jangan Di Klik</a></p>
			      </div>

			      <p><a href='?mod=add'><button type='button' class='btn btn-primary'><span class='glyphicon glyphicon-plus-sign'></span> Tambah Pengguna</button></a></p>
				    ...
				    <h2>Tambah Pengguna</h2>
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-1 col-sm-4">
					      <button type='submit' name='submit' class='btn btn-primary' onClick="return confirm('Yakin akan Tambah Data?')">Simpan Data</button>
					    </div>
					  </div>
					</form>
				<?php
